            ...
            <section id="about" className="min-h-screen bg-gradient-to-r from-purple-800 to-indigo-700 text-white py-16 px-6 flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <div className="w-full md:w-7/12 text-center md:text-left relative">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold leading-tight mb-4 pl-10">
                        <ul className="flex justify-right mt-5 space-x-5">
                            <li>
                                <a href="https://facebook.com/nazar.kuzia" className="text-white hover:text-gray-300">
                            ...
                            <li>
                                <a href="https://instagram.com/shwballl" className="text-white hover:text-gray-300">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        <path fill-rule="evenodd"
                            ...
                            <li>
                                <a href="https://x.com/shwballl" className="text-white hover:text-gray-300">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        <path
                            ...
                            <li>
                                <a href="https://github.com/shwballl" className="text-white hover:text-gray-300">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                        <path fill-rule="evenodd"
                        ...
                        A Passionate <br /> Backend Developer
                    </h2>

                    <p className="text-gray-300 mb-6 text-sm md:text-base leading-relaxed max-w-2xl mx-auto md:mx-0">
                        I’m Nazar Kuzia, a passionate Backend Developer with expertise in Django, Python, & modern web technologies. I specialize in building powerful and dynamic web applications. With a deep understanding of API integration and database management, I can bring your ideas to life.
                    </p>

                    <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                        <a href="#skills" className="border border-tertiary text-white font-semibold py-2 px-4 rounded-lg hover:bg-tertiary/10 text-center">
                            Tech Skills
                        </a>
